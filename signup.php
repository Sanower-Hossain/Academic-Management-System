...
if (isset($_POST['submit'])) {
    ...
    // Add a check to ensure the 'designation' key is set
    ...
    if ($row > 0) {
        ...
        $msg = mysqli_query($con, "insert into users(fname,lname,email,password,contact,designation,department) values('$fname','$lname','$email','$password','$contact','$designation','$department')");
