...
if (strlen($_SESSION['adminid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_query = "INSERT INTO courses (course_name, course_code, course_credit, session_id) VALUES ('$course_name', '$course_code', '$course_credit', '$session_id')";
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <form class="c" method="POST">
                        ...
                        <input type="number" name="course_credit" required>
