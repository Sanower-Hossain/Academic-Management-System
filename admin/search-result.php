...
$ret=mysqli_query($con,"select * from users where (fname like '%$searchkey%' || email like '%$searchkey%' || contact like '%$searchkey%')");
                              $cnt=1;
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td><?php echo $row['contact'];?></td>  <td><?php echo $row['posting_date'];?></td>
                                  <td>
